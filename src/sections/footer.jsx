...
function Footer(){
    return(
        <div className="footer bg-black border-t-1 border-white/10">
                <div className="w-full mx-auto grid lg:grid-cols-3 grid-cols-2">
                    <div className="border-e-2 border-white/10 p-4 text-white">
                    ...
                    <div className="lg:border-e-2 border-white/10 p-4">
