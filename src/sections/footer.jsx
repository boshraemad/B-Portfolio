                ...
                <div className="w-full mx-auto grid lg:grid-cols-3 grid-cols-2">
                    ...
                    <div className="lg:border-e-2 border-white p-4">
                        <ul className="text-sm text-white space-y-4">
                            <li className="hover:text-pink-300"><a href="#">Home</a></li>
                            <li className="hover:text-pink-300"><a href="#about-me">About Me</a></li>
                            <li className="hover:text-pink-300"><a href="#stats">Stats</a></li>
                        </ul>
                    </div>
