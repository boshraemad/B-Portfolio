...
function NavBar(){
    ...
    return(
        ...
        <nav className="relative bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 p-4">
        ...
        <div className=" absolute top-[80%] left-0 z-40 items-center justify-between hidden w-full md:flex md:w-auto md:order-1 transition-all duration-300" id="navbar-sticky">
